...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tweet.message'
        db.alter_column(u'nodejs_tweet', 'message', self.gf('django.db.models.fields.TextField')(max_length=140))

    def backwards(self, orm):

        # Changing field 'Tweet.message'
        db.alter_column(u'nodejs_tweet', 'message', self.gf('django.db.models.fields.CharField')(max_length=140))
